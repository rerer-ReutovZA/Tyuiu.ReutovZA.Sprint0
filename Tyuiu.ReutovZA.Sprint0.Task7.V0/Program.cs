...
using Tyuiu.ReutovZA.Sprint0.Task7.V0.Lib;

namespace Tyuiu.ReutovZA.Sprint0.Task7.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнил: Реутов Захар Александрович | ПКТб-25-1";
